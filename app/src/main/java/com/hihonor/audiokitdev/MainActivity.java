...
import com.hihonor.audiokitdev.activity.MultiChannelAudioDemoActivity;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button multiChannelAudioButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        multiChannelAudioButton = findViewById(R.id.multiChannelAudioButton);
        ...
        multiChannelAudioButton.setOnClickListener(this);
    }
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.earReturnAndRecordButton) {
            ...
            startActivity(intent);
        } else if (id == R.id.multiChannelAudioButton) {
            intent = new Intent(this, MultiChannelAudioDemoActivity.class);
            startActivity(intent);
        }
    }
}
